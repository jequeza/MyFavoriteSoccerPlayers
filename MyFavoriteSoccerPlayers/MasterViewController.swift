...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        listArray = [ "Bastian Schweinsteiger","Cristiano Ronaldo","Cuauhtemoc Blanco","Lionel Messi","Petr Cech","Ronaldinho","Ronaldo Nazario","Thierry Henry","Gianluigi Buffon","Zlatan Ibrahimovic"]
        title = "My Favorite Soccer Players"
